...
First, enter up to two persons as signers. Each person need a first name, a last name, and an email address. If any information is missing, the person will be ignored in this demo for the sake of simplicity. __Please note, that Sproof will send signature requests to the provided email addresses!__
...
![Create signing task](images/create-signing-task.png)
...
![Sign contract — choose signing mode](images/choose-signing-mode.png)
...
![Embedded IFrame — document view](images/embedded-iframe-document-view.png)
...
![Quick access dialog — signature fields](images/quick-access-signature-fields.png)
...
![All fields completed — continue to sign](images/all-fields-completed.png)
...
![Signature confirmed](images/signature-confirmed.png)
...
![Signed document and completed workflow](images/signed-document-finished-workflow.png)
